...
* Fix DownloadImageModal submit button being disabled when switching from a device type that has wifi network capability to one that does not [Matthew Yarmolinsky]
