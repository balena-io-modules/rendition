...
* Add new schema description properties [Andrea Rosci]

## 35.1.3 - 2023-12-21

* Update date-fns to v3.0.5 [Thodoris Greasidis]
* Changelog: Replace date-fns isBefore with a Date comparison [Thodoris Greasidis]
...
* Form: Add `widgets` prop for overriding internal Form widgets [myarmolinsky]

## 35.0.1 - 2023-08-09

* ButtonGroup: Add a key prop to the rendered options [Thodoris Greasidis]

## 35.0.0 - 2023-08-09

* Terminal: Remove the ResizeObserver polyfill [Thodoris Greasidis]
* DownloadImageModal: Drop the DeviceTypeInstructions type [Thodoris Greasidis]
* DownloadImageModal: Mark the OsVersion variant as non-nullable [Thodoris Greasidis]
* DownloadImageModal: Drop the deprecated formattedVersion property [Thodoris Greasidis]
* Stop actively supporting node versions below v14 [Thodoris Greasidis]

## 34.16.4 - 2023-07-27

* DownloadImageModal: Improve type safety for OS dependent instructions [Thodoris Greasidis]

## 34.16.3 - 2023-07-27

* Fix download image modal specific instructions [JSReds]
...
* Fix typing, code reduction and add getDescriptionProperty functionality [JSReds]

## 34.16.0 - 2023-06-26

* Restyle form fyle upload [JSReds]

## 34.15.7 - 2023-06-22

* Filters: prevent event propagation on Search enter [myarmolinsky]

## 34.15.6 - 2023-06-22

* Filters: Hide `Save view` button by default if not using `views` renderMode [myarmolinsky]

## 34.15.5 - 2023-06-20

* Filters: Add `showSaveView` to `Summary` to hide `Save view` button [myarmolinsky]

## 34.15.4 - 2023-06-19

* Update DownloadImageModal instructions typing [myarmolinsky]

## 34.15.3 - 2023-06-15

* Accept undefined values in the boolean widget [JSReds]

## 34.15.2 - 2023-06-06

* Add class to the "Show outdated images" checkbox [Pagan Gazzard]

## 34.15.1 - 2023-06-06

* Update snapshots [JSReds]
* Update flowzone.yml [Kyle Harding]

## 34.15.0 - 2023-05-22

* Add WrapWidget [myarmolinsky]

## 34.14.0 - 2023-05-22

* Add `null` as an acceptable type for DisabledTextWidget [myarmolinsky]

## 34.13.2 - 2023-05-22

* fix polling not waiting for previous request to complete [JSReds]

## 34.13.1 - 2023-05-11

* Search: Fix clear icon being visible when input is empty [myarmolinsky]

## 34.13.0 - 2023-05-03

* DownloadImageModal: Add `onFieldChange` and call `onDownloadStart` whenever a download is started, regardless of type [myarmolinsky]

## 34.12.0 - 2023-04-26

* DownloadImageModal: Use Badges when no formattedVersion is passed [Thodoris Greasidis]
* DownloadImageModal: Make the OS's formattedVersion property optional [Thodoris Greasidis]

## 34.11.0 - 2023-04-24

* Sidebar items: Add `disabled` and `tooltip` props [myarmolinsky]

## 34.10.0 - 2023-04-20

* Add interim solution to have a single column for multiple array  properties [JSReds]

## 34.9.2 - 2023-04-20

* Fix node 18.16.0 tests [JSReds]

## 34.9.1 - 2023-04-19

* Fix table cell make it always fit the content in one line [JSReds]

## 34.9.0 - 2023-04-18

* Add label on filter description when filter is oneOf [JSReds]

## 34.8.6 - 2023-04-17

* Fix build [JSReds]
* Fix DownloadImageModal download button when changing release [JSReds]

## 34.8.5 - 2023-03-28

* Fix table column selector, keep open on item click [JSReds]

## 34.8.4 - 2023-03-17

* Table: Restrict the tagField to be a string key of the entity type [Thodoris Greasidis]
...
* Update mermaid to v9.2.2 and fix storybook build [JSReds]

## 34.3.5 - 2022-11-23

* ChangelogButton: Open changelog modal automatically when there has been a major version change since last viewed [myarmolinsky]

## 34.3.4 - 2022-11-22

* Modal: Await the done callback to avoid double firing on Enter keypress [Thodoris Greasidis]
...
* Fix array filters creation [JSReds]

## 34.3.1 - 2022-11-14

* Hide Changelog button when Sidebar is collapsed [myarmolinsky]

## 34.3.0 - 2022-11-10

* Add Changelog component [Matthew Yarmolinsky]
...
* Filters: Enable `date-time` formats to have type `number` [JSReds]
...
* Reduce lodash usage in favor of native methods [Thodoris Greasidis]
* Fix TypeScript errors [Thodoris Greasidis]
* FilterModal: Allow false and 0 as valid values [Thodoris Greasidis]

## 34.0.0 - 2022-10-28

* Remove autoui in favour of @balena/autoui lib [JSReds]

## 33.0.4 - 2022-10-26

* Fix history confilcts and remove unused createBrowserHistory function [JSReds]

## 33.0.3 - 2022-10-04

* Move methods in appropriate file and review exports [JSReds]

## 33.0.2 - 2022-09-26

* Fix AutoUI entity lens not working with new keys and surface tags in it [Matthew Yarmolinsky]
...
* Group `Modify` dropdown by section instead of by danger [Matthew Yarmolinsky]
* Add `section` to `AutoUIAction` [Matthew Yarmolinsky]
* Change AutoUI `Actions` dropdown to be called `Modify` [Matthew Yarmolinsky]

## 32.0.10 - 2022-09-23

* Remove duplicate TagLabel and TagLabelList components [Matthew Yarmolinsky]

## 32.0.9 - 2022-09-23

* patch: Update dependency date-fns to ^2.29.3 [renovate[bot]]
...
* patch: Update dependency moment to ^2.29.4 [renovate[bot]]
...
* patch: Update dependency copy-to-clipboard to ^3.3.2 [renovate[bot]]

## 32.0.3 - 2022-09-22

* patch: Update dependency react to ^17.0.2 [renovate[bot]]

## 32.0.2 - 2022-09-22

* Fix views with long names getting cut off and hiding the trash icon [Matthew Yarmolinsky]

## 32.0.1 - 2022-09-21

* Drop no longer necessary @types/googlemaps devDependency [Thodoris Greasidis]

## 32.0.0 - 2022-09-21

* Add a repo.yml to allow flowzone to bump the versions [Thodoris Greasidis]
* AutoUI: Fix empty string values being converted to null when passed into widgets [Matthew Yarmolinsky]
* Unlock easymde sub-dependency [Thodoris Greasidis]
* Replace balena ci with flowzone [Thodoris Greasidis]
* Update react to v17 [Thodoris Greasidis]
* Filters: Fix the summary showing a `0` text [Thodoris Greasidis]

# v31.0.5
## (2022-09-21)

* Revert react-monaco-editor version to 0.45.0 to fix incompatibilities [JSReds]
...
* Unpin the @types/lodash package version [Thodoris Greasidis]

# v31.0.1
## (2022-09-20)

* Fix widget value to be based on refScheme [JSReds]

# v31.0.0
## (2022-09-19)

* Convert & fix jest & storybook files for latest typescript [Thodoris Greasidis]
* Update Mermaid to v9.1.0 [Thodoris Greasidis]
* Markdown: get the theme using a hook [Thodoris Greasidis]
* Upgrade typescript to 4.8.3 [JSReds]

# v30.0.0
## (2022-09-12)

* Refactor Filters and add x-ref-scheme/x-foreign-key-scheme support [JSReds]

# v29.0.0
## (2022-07-15)

* Drop Modal component's `titleElement` and `titleDetails` properties in favor of the `title` property and add `JSX.Element` as an acceptable type for `title` [Matthew Yarmolinsky]

# v28.6.2
## (2022-07-11)

* Make MenuItem badge small when Sidebar is collapsed [Matthew Yarmolinsky]

# v28.6.1
## (2022-07-04)

* Change all JSONSchema imports to be explicitly type only [Thodoris Greasidis]
* Fix storybook issue trying to import type only json-schema package [Thodoris Greasidis]

# v28.6.0
## (2022-07-01)

* Add optional `badge` property to Sidebar MenuItem [Matthew Yarmolinsky]

# v28.5.0
## (2022-07-01)

* Add theme primary color main to Badge shades [Matthew Yarmolinsky]
...
* Fix notification message always saying `Updating release tags...` when updating tags [Matthew Yarmolinsky]

# v28.4.0
## (2022-06-24)

* Export CaretButton component [Matthew Yarmolinsky]

# v28.3.0
## (2022-06-23)

* Update downloadOptions to include provisioning key expiry date [Nitish Agarwal]

# v28.2.1
## (2022-06-22)

* patch: Update dependency jsdom to v16 [SECURITY] [renovate[bot]]

# v28.2.0
## (2022-06-22)

* Update AutoUI affectedEntries for actions when selected data updates [Matthew Yarmolinsky]

# v28.1.1
## (2022-06-13)

* Fix shift clicking in a table with sorted columns [Matthew Yarmolinsky]

# v28.1.0
## (2022-06-13)

* Add shift-clicking to select multiple table rows [Matthew Yarmolinsky]

# v28.0.0
## (2022-06-09)

* Remove Box from Card component to avoid nesting Box and Flex components [Matthew Yarmolinsky]

# v27.7.0
## (2022-06-07)

* Add array of strings searchtext support and refactor function [JSReds]

# v27.6.0
## (2022-06-06)

* Show error in download image modal if poll interval value is invalid [Matthew Yarmolinsky]

# v27.5.0
## (2022-06-02)

* Add docs link to poll interval field in download image modal [Matthew Yarmolinsky]

# v27.4.3
## (2022-06-01)

* Fix duration widget when one value is null [JSReds]

# v27.4.2
## (2022-05-31)

* Fix useReqeust [JSReds]

# v27.4.1
## (2022-05-30)

* Remove pointer style rule if row is not clickable [JSReds]

# v27.4.0
## (2022-05-30)

* Add Renderer widgets [JSReds]

# v27.3.1
## (2022-05-29)

* Fix Poll Class build error [JSReds]

# v27.3.0
## (2022-05-23)

* Add export for Poll class [JSReds]
* Add Sidebar component [JSReds]

# v27.2.0
## (2022-05-17)

* Add `disabled` property to ButtonGroup component [Matthew Yarmolinsky]

# v27.1.3
## (2022-05-10)

* Fix filters containing dots [JSReds]
...
* Fix boolean filters [JSReds]

# v27.1.0
## (2022-04-21)

* Add Breadcrumbs dark mode [JSReds]

# v27.0.1
## (2022-04-20)

* Fix all numeric operators filters [JSReds]

# v27.0.0
## (2022-04-18)

* Remove TextWithCopy component [jmakivic]
* Add copy functionality to Txt [Balena CI]

# v26.4.2
## (2022-04-15)

* Fix search for lists of items and items of type object [JSReds]

# v26.4.1
## (2022-04-15)

* patch: Update fontawesome to ^6.1.1 [Renovate Bot]

# v26.4.0
## (2022-04-14)

* Add array and object sort based on refScheme [JSReds]

# v26.3.0
## (2022-04-14)

* Add autoui refscheme support [JSReds]

# v26.2.1
## (2022-04-14)

* patch: Update dependency styled-components to ^5.3.5 [Renovate Bot]

# v26.2.0
## (2022-04-14)

* Add support for array of objects in filters [JSReds]
...
* Add export for CollectionSummary component [Matthew Yarmolinsky]

# v26.0.0
## (2022-04-01)

* Download Image Modal: Rename OsVersion property rawVersion to raw_version [Matthew Yarmolinsky]
...
* patch: Update dependency qs to ^6.10.3 [Renovate Bot]
