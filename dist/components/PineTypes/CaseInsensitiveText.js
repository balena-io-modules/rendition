...
exports.Display = exports.Edit = exports.validate = exports.rules = exports.toLowerCase = exports.converter = undefined;
...
var converter = exports.converter = new _showdown2.default.Converter();

var toLowerCase = exports.toLowerCase = function toLowerCase(fn) {
...
var rules = exports.rules = {
  is: toLowerCase(function () {
    var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var value = arguments[1];
    return target === value;
  }),
  contains: toLowerCase(function () {
    var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var value = arguments[1];
    return target.includes(value);
  }),
  'does not contain': toLowerCase(function () {
    var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var value = arguments[1];
    return !target.includes(value);
  }),
  'matches RegEx': toLowerCase(function () {
    var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var value = arguments[1];
    return target.match((0, _regexParser2.default)(value));
  }),
  'does not match RegEx': toLowerCase(function () {
    var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var value = arguments[1];
    return !target.match((0, _regexParser2.default)(value));
  })
...
var Edit = function Edit(_ref) {
  ...
  return (0, _preact.h)(_Textarea2.default, _extends({ onChange: function onChange(e) {
