  ...
  .add('Standard', () => {
    return (
      <Provider>
        ...
        <Box m={3}>
          <Toggle mx={2} on success onToggle={action('case-2')} />
          <Txt.span>Success</Txt.span>
        </Box>
        <Box m={3}>
          <Toggle mx={2} on danger onToggle={action('case-3')} />
          <Txt.span>Danger</Txt.span>
        </Box>
        <Box m={3}>
          <Toggle mx={2} on warning onToggle={action('case-4')} />
          <Txt.span>Warning</Txt.span>
        </Box>
        <Box m={3}>
          <Toggle mx={2} on info onToggle={action('case-5')} />
