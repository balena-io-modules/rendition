...
describe('migrations', () => {
  describe('.migrateLegacyFilter()', () => {
    ...
    forEach(
      legacyTypesAndOperators,
      ({ v4Type, operators, testValue }, legacyType) => {
    ...
    it('should ignore input that is already migrated', () => {
      ...
      const migratedFilter = migrations.migrateLegacyFilter(
        newSchema,
        oldFilter
      )

      const reMigratedFilter = migrations.migrateLegacyFilter(
        newSchema,
        migratedFilter
      )
